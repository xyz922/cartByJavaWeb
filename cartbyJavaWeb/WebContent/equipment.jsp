		...
		<div class="card" style="width:100%">       
			<ul class=" nav nav-pills list-group list-group-flush">
				<ul class="nav flex-column nav-pills" id="v-pills-tab" role="tablist">
					...
					<li class=" list-group-item nav-item"><a class="nav-link  active" data-toggle="pill" href="equipment.jsp">电子设备</a></li>
				</ul>
			</ul>
		</div>
	</div>
	<!-- 电子设备-->
	<div id="v-pills-equipment" class="container  tab-pane active">
		<div class="col-lg-10">
			<div class="row">
				<div class="card col-lg-4" style="height:350px;">
					<img src="images/equipment01.jpg" class="card-img-top" width="75%" height="250px">
					<div class="card-body">
						<h5 class="card-title">设备1</h5>
					</div>
				<button type="button" value="equipment01" class=" btn btn-primary">加入购物车</button>
				</div>
				<div class="card col-lg-4" style="height:350px;">
					<img src="images/equipment02.jpg" class="card-img-top" width="75%" height="250px">
					<div class="card-body">
						<h5 class="card-title">设备2</h5>
					</div>
					<button type="button" value="equipment02" class=" btn btn-primary">加入购物车</button>
				</div>
			</div>
		</div>
	</div>
